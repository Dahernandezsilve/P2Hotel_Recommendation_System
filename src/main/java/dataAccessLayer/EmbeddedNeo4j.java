...
public class EmbeddedNeo4j implements AutoCloseable{
    ...
    public LinkedList<String> getMoviesByActor(String actor)
	{
       ...
       public String insertHotel(String name, String idHotel, String breakfastHotel, String calificationHotel, String description, String petsHotel, String direction, String TypePlace, String poolHotel, String priceHotel, String wifiHotel) {
    	try ( Session session = driver.session() )
        {
   		 ...
   		 
            {
                ...
                public String execute( Transaction tx )
                {
                    tx.run( "CREATE (n:Hotel {name:'" + name + "', id:"+ idHotel + ", breakfast:"+ breakfastHotel +", calification:"+ calificationHotel +", description:'"+ description + "', pets:"+ petsHotel +", direction:'"+ direction +", Type Place:'"+ TypePlace +"', pool:"+ poolHotel + ", price:"+ priceHotel +", wifi:"+ wifiHotel+"})");
